...
def assignPoints(ptsRec, ptsRecUnitization, sourceUnitization, argUnitization, argVal, sourceVal, article, journalist):
    ...
    :param sourceUnitization: list of eveyr index of the source unitization that is most similar to the ptsRecUnitization
    :param argUnitization: list of eveyr index from the argument unitization that is most similar to the ptsRecUnitization
    :param argVal: the answer to the question about this from the argument task
    :param sourceVal: answer to the relevant question from the source task
    :param article:
    :param journalist:
    :return:
    """
